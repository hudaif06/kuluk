...
import 'package:kuluk_app/screens/contact/presenter.dart';
      ...
      child: Stack(
        children: [
          Column(
            children: [
              const Text(
                "Select a contact from your phone contact\nfor each Gesture ",
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          const Text(
                            "One Shake",
                            style: FontConstants.W_MediumFont2,
                          ),
                          InkWell(
                            onTap: () {
                              Navigator.push(
