...
class _CallPageState extends State<CallPage> {
  ...
  void initState() {
    ...
    super.initState();
    ShakeDetector detector = ShakeDetector.autoStart(shakeCountResetTime: 5000,shakeSlopTimeMS: 1000,
        onPhoneShake: () {counter++;
              ...
              children: [
                Expanded(
                  child: Column(
                    ...
                    children:  [
                      const Text("  Welcome to Gesture\nbased shake app Kuluk !",style: FontConstants.B_AboveMediumFont,),
                      const SizedBox(height: 27,),
                      Image.asset("assets/images/logo.png"),
                      const SizedBox(height: 27,),
                      const Text("Shake or Tap the phone to call",style: FontConstants.B_AboveMediumFont,),
                    ],
                  ),
                ),
              ],
