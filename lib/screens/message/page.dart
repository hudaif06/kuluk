...
import 'package:kuluk_app/screens/message/presenter.dart';
              ...
              child: Column(
                children: [
                  Expanded(
                    ...
                    children: [
                      const Text(
                        "Type or Click on Template",
                        style: FontConstants.W_SmallFont2,
                      ),
                      Expanded(
                        flex: 3,
                        child: Container(
                              ...
                              Positioned(
                                  ...
                                  child: TextButton(
                                      style: TextButton.styleFrom(
                                          backgroundColor:
                                              const Color(0xFFd6d8d7),
                                          primary: Colors.black),
                                      onPressed: () {
                                        // textMe();
                                        Fluttertoast.showToast(
                                            msg:
                                                "Shake your phone to send message",
                                ...
                                children: [
                                  InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Text(
                                        messages.text1,
                                        style: FontConstants.G_SmallFont,
                                      ),
                                    ),
                                  ),
                                  const Divider(
